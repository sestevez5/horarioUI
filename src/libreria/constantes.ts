import { IDiaSemana } from "./modelo/diaSemana.model";
import { IGrafico } from "./modeloGrafico/Grafico.model";

export const CONFIGURACION_GRAFICO: IGrafico = {
...
export const DIAS_SEMANA: Array<IDiaSemana> = [
